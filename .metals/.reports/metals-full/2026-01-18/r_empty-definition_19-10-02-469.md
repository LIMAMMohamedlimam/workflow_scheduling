error id: file://<WORKSPACE>/src/main/java/org/example/CustomCostSimulation.java:java/lang/Double#parseDouble().
file://<WORKSPACE>/src/main/java/org/example/CustomCostSimulation.java
empty definition using pc, found symbol in pc: java/lang/Double#parseDouble().
