error id: file://<WORKSPACE>/src/main/java/org/example/CustomCostSimulation.java:_empty_/WorkflowMetrics#calculateAndPrint#
file://<WORKSPACE>/src/main/java/org/example/CustomCostSimulation.java
empty definition using pc, found symbol in pc: _empty_/WorkflowMetrics#calculateAndPrint#
...
public class CustomCostSimulation {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<String> datasets = new ArrayList<>(Arrays.asList(
             "task40", "task80", "task120", "task160" , "task200", "task240"
        ));
    ...
    for (int i = 0; i < tasks.size(); i++) {
        ...
        metrics.calculateA@@ndPrint(SCHEDULING_ALGORITHM , DATASET_USED);
    }
