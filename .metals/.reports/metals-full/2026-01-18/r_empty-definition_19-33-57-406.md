error id: file://<WORKSPACE>/src/main/java/org/example/CustomCostSimulation.java:java/lang/System#out.
...
public class CustomCostSimulation {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < tasks.size(); i++) {
            TaskSpec task = tasks.get(i);
            System.o@@ut.println("Creating cloudlet for task: " + task.taskId);
