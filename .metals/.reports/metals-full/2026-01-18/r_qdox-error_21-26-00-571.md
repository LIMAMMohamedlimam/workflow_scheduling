...
### com.thoughtworks.qdox.parser.ParseException: syntax error @[271,5]
...
public class CustomCostSimulation {
    ...
    for (int i = 0; i < tasks.size(); i++) {
        ...
        metrics.calculateAndPrint(SCHEDULING_ALGORITHM , );
    }
...
QDox parse error in file://<WORKSPACE>/src/main/java/org/example/CustomCostSimulation.java