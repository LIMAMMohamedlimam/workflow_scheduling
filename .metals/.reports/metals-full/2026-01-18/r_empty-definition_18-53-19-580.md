error id: file://<WORKSPACE>/src/main/java/org/example/WorkflowMetrics.java:_empty_/NodeSpec#
file://<WORKSPACE>/src/main/java/org/example/WorkflowMetrics.java
empty definition using pc, found symbol in pc: _empty_/NodeSpec#
...
public class WorkflowMetrics {
    ...
    private final List<Node@@Spec> nodes;
