error id: file://<WORKSPACE>/src/main/java/org/example/WorkflowMetrics.java:_empty_/Cloudlet#getId#
file://<WORKSPACE>/src/main/java/org/example/WorkflowMetrics.java
empty definition using pc, found symbol in pc: _empty_/Cloudlet#getId#
...
public class WorkflowMetrics {
    ...
    private double calculateTotalCost() {
        ...
        for (int i = 0; i < cloudlets.size(); i++) {
            ...
            Vm vm = vms.get(cloudletToVmMap.get((int)cloudlet.get@@Id()));
