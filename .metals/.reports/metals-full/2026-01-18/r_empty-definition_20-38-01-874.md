error id: file://<WORKSPACE>/src/main/java/org/example/CustomCostSimulation.java:org/example/CustomCostSimulation#getSchedulingAlgorithm#
file://<WORKSPACE>/src/main/java/org/example/CustomCostSimulation.java
empty definition using pc, found symbol in pc: org/example/CustomCostSimulation#getSchedulingAlgorithm#
...
public class CustomCostSimulation {
    ...
    private static final String SCHEDULING_ALGORITHM = "SA_MultiObjective"; // Options: ROUNDROBIN, FCFS, SA_MultiObjective
    ...
    for (int i = 0; i < tasks.size(); i++) {
        ...
        if (IS_MultiObjective == 1) {
            SchedulingAlgorithm scheduler = getS@@chedulingAlgorithm(SCHEDULING_ALGORITHM , 0.5 , 0.3 , 0.2);
        }
        SchedulingAlgorithm scheduler = getSchedulingAlgorithm(SCHEDULING_ALGORITHM);
...
private static SchedulingAlgorithm getSchedulingAlgorithm(String algorithmName) {
    switch (algorithmName.toUpperCase()) {
        ...
        case "SA_MULTIOBJECTIVE":
            return new MultiObjectiveSAScheduling(0.5, 0.3, 0.2);
        // case "MINMIN":
...
private static SchedulingAlgorithm getSchedulingAlgorithm(String algorithmName , long wmakespan , long wcost , long wenergy) {
    switch (algorithmName.toUpperCase()) {
