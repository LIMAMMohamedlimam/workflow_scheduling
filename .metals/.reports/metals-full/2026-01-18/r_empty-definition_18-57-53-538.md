error id: file://<WORKSPACE>/src/main/java/org/example/WorkflowMetrics.java:
...
org.c@@loudsimplus.power.models.PowerModelHost;
...
private double calculateTotalEnergy() {
    ...
    for (NodeSpec node : nodes) {
        ...
        for (Host host : dc.getHostList()) {
            ...
            double hostEnergy = powerModel.getTotalEnergyConsumption();
