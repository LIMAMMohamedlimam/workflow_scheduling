error id: file://<WORKSPACE>/src/main/java/org/example/CustomCostSimulation.java:_empty_/`<any>`#setRam#setBw#setSize#setCloudletScheduler#
file://<WORKSPACE>/src/main/java/org/example/CustomCostSimulation.java
empty definition using pc, found symbol in pc: _empty_/`<any>`#setRam#setBw#setSize#setCloudletScheduler#
    ...
    public static void main(String[] args) {
        ...
        for (NodeSpec node : nodes) {
            Vm vm = new VmSimple(node.mipsRating, 2)
                    ...
                    .setBw(10000)
                    .setSize(50000)
                    .setCloudletSchedule@@r(new CloudletSchedulerSpaceShared());
