error id: file://<WORKSPACE>/src/main/java/org/example/CustomCostSimulation.java:java/lang/String#
...
public class CustomCostSimulation {
    ...
    private static List<NodeSpec> loadNodesFromCSV(St@@ring filename) {
