error id: file://<WORKSPACE>/src/main/java/org/example/CustomCostSimulation.java:java/lang/Integer#
...
public class CustomCostSimulation {
    ...
    for (int i = 0; i < tasks.size(); i++) {
        ...
        Cloudlet cloudlet = new CloudletSimple(task.instructions, 2)
                ...
                .setUtilizationModelRam(new UtilizationModelFull())
                .setUtilizationModelBw(new UtilizationModelFull())
                .setId((task.taskId.replace("Task_", "")).parseLong()); // Set cloudlet ID based on task ID
        ...
        Map<Integer, Inte@@ger> cloudletToVmMap = scheduler.schedule(cloudlets, vms, tasks, nodes);
