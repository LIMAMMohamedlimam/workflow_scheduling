error id: file://<WORKSPACE>/src/main/java/org/example/CustomCostSimulation.java:_empty_/SchedulingAlgorithm#schedule#
file://<WORKSPACE>/src/main/java/org/example/CustomCostSimulation.java
empty definition using pc, found symbol in pc: _empty_/SchedulingAlgorithm#schedule#
...
public class CustomCostSimulation {
    ...
    for (int i = 0; i < tasks.size(); i++) {
        ...
        Map<Integer, Integer> cloudletToVmMap = scheduler.sche@@dule(cloudlets, vms, tasks, nodes);
